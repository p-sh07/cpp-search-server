...
const std::string INVALID_ID_MSG = "SearchServer ERROR: Adding invalid DocumentID";
const std::string EXISTING_ID_MSG = "ERROR: Adding duplicate DocumentID";
const std::string INPUT_INVALID_SYMBOLS_MSG = "SearchServer ERROR: Invalid symbols in input";
const std::string QUERY_INVALID_DOCID_MSG = "SearchServer ERROR: Invalid symbols in query";
